...
public class P13Design {
    ...
    static class LRUCacheLinked extends LinkedHashMap<Integer, Integer> {
        ...
        private final int cap;
        LRUCacheLinked(int capacity) { super(16, 0.75f, true); cap = capacity; }
        int get(int key) { return super.getOrDefault(key, -1); }
        void put2(int key, int value) { super.put(key, value); }
        @Override protected boolean removeEldestEntry(Map.Entry<Integer, Integer> eldest) { return size() > cap; }
    }
    ...
    static class TimeMap {
        ...
        void set(String k, String v, int t) { store.computeIfAbsent(k, x -> new TreeMap<>()).put(t, v); }
    ...
    public static void main(String[] args) {
        ...
        l.put2(1, 1); l.put2(2, 2); l.get(1); l.put2(3, 3);
        ...
        assert tm.get("foo", 3).equals("bar") && tm.get("foo", 5).equals("bar2") && tm.get("foo", 0).isEmpty();
